...
$(document).ready(function(){
    ...
    $('body').on('click', '#project_list > li', function(e){
        e.preventDefault();
        $("#this_project").html($(this).text());
    });
    /*
     * Text Feild
     */
...
;(function($,window,document,undefined){
    ...
    jQuery.extend({
        html_encode:function (str) {
            var mu=new MU();
            return mu.html_encode(str);
        },
        html_decode:function (str) {
            var mu=new MU();
            return mu.html_decode(str);
        }
    });
    MU.prototype.html_encode=function (str) {
        return $('<div/>').text(str).html();
    }

    //解码
    MU.prototype.html_decode=function (str) {
    ...
    MU.prototype.openModal=function (parent,options) {
        var $dom=$('<div class="modal fade" id="'+options['id']+'" tabindex="-1" role="dialog"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><button type="button" class="close close-modal" data-dismiss="modal" aria-hidden="true">×</button><h4 class="modal-title" id="ModalLabel">'+options['title']+'</h4></div><div class="modal-body form-horizontal">'+options['body']+'</div><div class="modal-footer">'+options['footer']+'</div></div></div></div>');
        parent.append($dom);
    }
